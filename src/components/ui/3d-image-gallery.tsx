...
function CardProvider({ children }: { children: React.ReactNode }) {
    ...
    const cards: Card[] = [
        { id: "1", imageUrl: "https://picsum.photos/seed/1/400/600", alt: "Elegant Invitation", title: "Elegant Invitation" },
        { id: "2", imageUrl: "https://picsum.photos/seed/2/400/600", alt: "Modern Design", title: "Modern Design" },
        { id: "3", imageUrl: "https://picsum.photos/seed/3/400/600", alt: "Vintage Style", title: "Vintage Style" },
        { id: "4", imageUrl: "https://picsum.photos/seed/4/400/600", alt: "Minimalist", title: "Minimalist" },
        { id: "5", imageUrl: "https://picsum.photos/seed/5/400/600", alt: "Floral Design", title: "Floral Design" },
        { id: "6", imageUrl: "https://picsum.photos/seed/6/400/600", alt: "Geometric", title: "Geometric" },
        { id: "7", imageUrl: "https://picsum.photos/seed/7/400/600", alt: "Luxury Gold", title: "Luxury Gold" },
        { id: "8", imageUrl: "https://picsum.photos/seed/8/400/600", alt: "Rustic Style", title: "Rustic Style" },
        { id: "9", imageUrl: "https://picsum.photos/seed/9/400/600", alt: "Dark Modern", title: "Dark Modern" },
        { id: "10", imageUrl: "https://picsum.photos/seed/10/400/600", alt: "Colorful Party", title: "Colorful Party" },
        { id: "11", imageUrl: "https://picsum.photos/seed/11/400/600", alt: "Geometric", title: "Geometric" },
        { id: "12", imageUrl: "https://picsum.photos/seed/12/400/600", alt: "Luxury Gold", title: "Luxury Gold" },
        { id: "13", imageUrl: "https://picsum.photos/seed/13/400/600", alt: "Rustic Style", title: "Rustic Style" },
        { id: "14", imageUrl: "https://picsum.photos/seed/14/400/600", alt: "Dark Modern", title: "Dark Modern" },
        { id: "15", imageUrl: "https://picsum.photos/seed/15/400/600", alt: "Colorful Party", title: "Colorful Party" },
        { id: "16", imageUrl: "https://picsum.photos/seed/16/400/600", alt: "Elegant Script", title: "Elegant Script" },
        { id: "17", imageUrl: "https://picsum.photos/seed/17/400/600", alt: "Watercolor Art", title: "Watercolor Art" },
        { id: "18", imageUrl: "https://picsum.photos/seed/18/400/600", alt: "Botanical", title: "Botanical" },
        { id: "19", imageUrl: "https://picsum.photos/seed/19/400/600", alt: "Art Deco", title: "Art Deco" },
        { id: "20", imageUrl: "https://picsum.photos/seed/20/400/600", alt: "Marble Luxury", title: "Marble Luxury" },
    ]
...
function FloatingCard({
    ...
    const handlePointerOver = (e: any) => { // eslint-disable-line @typescript-eslint/no-explicit-any
        e.stopPropagation()
        setHovered(true)
        document.body.style.cursor = "pointer"
    }
    const handlePointerOut = (e: any) => { // eslint-disable-line @typescript-eslint/no-explicit-any
        e.stopPropagation()
        setHovered(false)
