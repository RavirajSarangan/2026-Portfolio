...
export function WorldMap({
    ...
    const svgMap = useMemo(
        () => map.getSVG({
            radius: 0.22,
            color: "#8b5cf640", // Accent purple dots
            shape: "circle",
    ...
    return (
        <div className="w-full aspect-[2/1] md:aspect-[2.5/1] lg:aspect-[2/1] bg-black rounded-lg relative font-sans overflow-hidden border border-white/5">
            <Image
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center justify-center h-full">
                                                <span className="text-[10px] font-medium px-2 py-0.5 rounded-md bg-black/90 text-white border border-accent/30 shadow-lg uppercase tracking-tighter">
                                                    {dot.start.label}
                                                </span>
                                            </div>
                                        </foreignObject>
