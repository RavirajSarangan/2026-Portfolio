...
export function middleware(request: NextRequest) {
    ...
    const cspDirectives = {
        ...
        "font-src": ["'self'", "data:"],
        "connect-src": ["'self'", "https://cdn.jsdelivr.net", "https://raw.githubusercontent.com", "https://storage.googleapis.com", "https://assets.unicorn.studio", "https://simpleicons.org", isDev ? "ws:" : ""],
